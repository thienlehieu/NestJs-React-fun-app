...
const Pagination = ({pages, setCurrentPage, currentEmployees, allEmployees}) => {
    ...
    useEffect(() => {
        console.log("set current page was called")
        setCurrentPage(currentButton);
    }, [currentButton, setCurrentPage])

    return (
        <div className="clearfix">
        <div className="hint-text"> Showing <b>{currentEmployees.length}</b> Of <b>{allEmployees.length}</b> Users </div>
